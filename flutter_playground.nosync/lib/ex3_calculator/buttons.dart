...
class NumberButton extends StatelessWidget {
  ...
  const NumberButton({super.key, required this.number, required this.handleOnPressed});
...
class OperationButton extends StatelessWidget {
  ...
  const OperationButton({super.key, required this.operation, required this.handleOnPressed});
